...
declare module '@joint/core' {
    ...
    export namespace dia {
        ...
        class CommandManager extends mvc.Model<CommandManager.Options> {
        ...
        class Validator extends mvc.Model {
    ...
    export namespace layout {
        ...
        class TreeLayout extends mvc.Model {
    ...
    export namespace shapes {
        ...
        export namespace bpmn2 {
            ...
            export class Choreography extends dia.Element {
                constructor(
                    attributes?: Choreography.Attributes<Choreography.Selectors>,
                    opt?: dia.Graph.Options
                )
        ...
        export namespace chart {
            ...
            class Plot extends dia.Element {
                ...
                legendPosition(position: Plot.Position, opt?: { [key: string]: any }): void;
            ...
            class PlotView extends dia.ElementView { }

            class Matrix extends dia.Element {
            ...
            class MatrixView extends dia.ElementView { }

            class Pie extends dia.Element {
            ...
            class PieView extends dia.ElementView { }

            class Knob extends Pie {

                constructor(attributes?: Knob.Attributes, opt?: { [key: string]: any });
            }

            class KnobView extends dia.ElementView { }
        }
    }

    /* Extra JointJS+ namespaces */
    ...
    export namespace ui {
        ...
        class Clipboard extends mvc.Collection<mvc.Model> {
        ...
        class Inspector extends mvc.View<undefined> {
            ...
            updateCell(): void;
            updateCell(attrNode: mvc.$HTMLElement, attrPath: string, opt?: { [key: string]: any }): void;
            ...
            static create(container: mvc.$HTMLElement, opt?: Inspector.Options): ui.Inspector;

            static close(): void;

            protected renderGroup(opt?: { [key: string]: any }): HTMLDivElement;

            protected renderOwnFieldContent(opt?: { [key: string]: any }): HTMLElement[];

            protected renderOwnLabel(opt?: { [key: string]: any }): HTMLElement[];

            protected replaceHTMLEntity(entity: any, code: any): void;

            protected renderObjectProperty(opt?: { [key: string]: any }): HTMLElement;

            protected renderListItem(opt?: { [key: string]: any }): HTMLElement;

            protected renderFieldContainer(opt?: { [key: string]: any }): HTMLElement;

            protected renderTemplate(el: mvc.$Element | null, options: { [key: string]: any }, path: string, opt?: { [key: string]: any }): void;
            ...
            protected processInput(input: HTMLElement, opt: { [key: string]: any }): void;
        ...
        class Stencil extends mvc.View<undefined> {
            ...
            load(groups: { [groupName: string]: Array<dia.Cell | mvc.ObjectHash> }): void;
    ...
    export namespace format {
        ...
        interface PrintExportOptions {
            ...
            area?: g.Rect;
            ready?: (pages: HTMLDivElement[], printAction: PrintAction, opt: { sheetSizePx: dia.Size & { cssWidth: string, cssHeight: string } }) => void;
        ...
        export function toPNG(paper: dia.Paper, callback: (dataURL: string, error?: Error) => void, opt?: RasterExportOptions): void;

        export function toDataURL(paper: dia.Paper, callback: (dataURL: string, error?: Error) => void, opt?: RasterExportOptions): void;

        export function toJPEG(paper: dia.Paper, callback: (dataURL: string, error?: Error) => void, opt?: RasterExportOptions): void;

        export function toSVG(paper: dia.Paper, callback: (svg: string, error?: Error) => void, opt?: SVGExportOptions): void;

        export function toCanvas(paper: dia.Paper, callback: (canvas: HTMLCanvasElement, error?: Error) => void, opt?: CanvasExportOptions): void;

        export function openAsSVG(paper: dia.Paper, opt?: SVGExportOptions): void;

        export function openAsPNG(paper: dia.Paper, opt?: RasterExportOptions): void;

        export function print(paper: dia.Paper, opt?: PrintExportOptions): void;
    }
